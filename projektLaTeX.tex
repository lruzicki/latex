...
\end{enumerate}
\begin{center}
\includegraphics[width=0.28 \paperwidth]{obrazy/dwa.jpg}
\end{center}
...
\begin{flushright}
\includegraphics[width=0.3 \paperwidth]{obrazy/piec.jpg}
\end{flushright}
...
\begin{flushright}
\includegraphics[width=0.3 \paperwidth]{obrazy/siedem.jpg}
\end{flushright}
...
\begin{center}
\vspace{-20pt}
\includegraphics[width=0.35\textwidth]{obrazy/osiem}
\end{center}
\vspace{-20pt}
...
\begin{center}
\includegraphics[width=0.3 \paperwidth]{obrazy/bowl.png}
\end{center}
